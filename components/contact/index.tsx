...
export default function ContactSection() {
    ...
    return (
        <section className="min-h-screen bg-background/80 backdrop-blur-md relative overflow-hidden flex items-center justify-center py-20 border-t border-t-foreground/20">
